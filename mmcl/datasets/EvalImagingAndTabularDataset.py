...
class EvalImagingAndTabularDataset(Dataset):
  """
  ...
  def __init__(
      self,
      data_path_imaging: str, delete_segmentation: bool, augmentation: transforms.Compose, eval_train_augment_rate: float, 
