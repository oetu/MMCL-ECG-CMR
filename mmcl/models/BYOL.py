...
from models.SiameseArm import SiameseArm
...
class BYOL(LightningModule):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.online_network = SiameseArm(model, embedding_dim, projector_hidden_dim, projector_out_dim, **kwargs)
    ...
    def _shared_step(self, batch: Any, batch_idx: int, step: str) -> Tensor:
        ...
        # Log losses
        if step == "train":
            self.log_dict({"train_loss_12": loss_12, "train_loss_21": loss_21, "ecg.train.loss": total_loss, "variance_z1": z1.var(), "variance_z2": z2.var()})
        elif step == "val":
            self.log_dict({"val_loss_12": loss_12, "val_loss_21": loss_21, "ecg.val.loss": total_loss})
        else:
