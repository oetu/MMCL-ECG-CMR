...
class BarlowTwins(LightningModule):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.network = SiameseArm(model, embedding_dim, projector_hidden_dim, projector_out_dim, **kwargs)
    ...
    def _shared_step(self, batch: Any, batch_idx: int, step: str) -> Tensor:
        ...
        # Log losses
        if step == "train":
            self.log_dict({"ecg.train.loss": loss})
        elif step == "val":
            self.log_dict({"ecg.val.loss": loss})
        else:
